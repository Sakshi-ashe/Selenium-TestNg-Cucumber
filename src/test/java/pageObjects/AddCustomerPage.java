...
public class AddCustomerPage {
	...
	By vendorOne = By.xpath("//option[contains(text(),'Vendor 1')]");
	By vendorTwo = By.xpath("//option[contains(text(),'Vendor 2')]");
	By NotAVendor = By.xpath("//option[contains(text(),'Not a vendor')]");
